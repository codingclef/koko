...
현재 제품 범위는 캘린더, 반복 일정, 장보기 목록, 가족 초대/합류, 사용자 설정, Web Push 알림입니다.
...
- `src/app/shopping/[id]/page.tsx`는 구형 링크를 `/calendar?tab=shopping&list=...`로 연결하는 bridge route입니다
...
- [`src/components/tabs/ShoppingTab.tsx`](/Users/codingclef/workspace_codex/koko/src/components/tabs/ShoppingTab.tsx): 장보기 개요 컨테이너
